...
module.exports = { uri: process.env.MONGO_URI || '', MONGO_DB: process.env.MONGO_DB || 'MTKDATA',
  COLLECTION: process.env.MONGO_COLLECTION || 'iotdatas', SENSORS_COLLECTION:process.env.MONGO_SENSORS_COLLECTION||'sensors', PORT, STALE_MS: seconds * 1000, ALLOW_LAN, GPS_PRIVACY_ENABLED, GPS_LAT_OFFSET, GPS_LON_OFFSET,
