...
export async function mount(page,{items,id,getJSON}){
  ...
  return ()=>{alive=false;requests.forEach((value,key)=>requests.set(key,value+1));charts.forEach(chart=>chart.destroy());charts.clear();};
}
